...
<div class="container">
    ...
    <div class="row">
        <table class="table">
            <tr>
                <td>ID</td>
                <td>Fisheries Name</td>
                <td>Fisheries Price</td>
                <td>Location</td>
            </tr>
            <?php
            foreach ($fisheries as $fisherie) {
            ?>
            <tr>
                <td><?php echo $fisherie->id ?></td>
                <td><?php echo $fisherie->fisheries_name ?></td>
                <td><?php echo $fisherie->fisheries_price ?></td>
                <td><?php echo $fisherie->location ?></td>
            </tr>
            <?php
            }
            ?>
